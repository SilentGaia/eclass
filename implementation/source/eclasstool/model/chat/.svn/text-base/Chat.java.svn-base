...
//   private Registry registry;
   ...
   public ArrayList<Chatroom> getChatrooms() {
      System.out.println("In Chat.showChatroomList");
      return chatrooms;
   }
   ...
   public void createChatroom() {
      //System.out.println("In Chat.createChatroom");
   ...
   public void setChatroom(Chatroom chatroom) {
      ...
      //System.out.println("In Chat.setChatroom");
   }
   ...
   public void setChatroom(int index) {
      ...
      System.out.println("Current chatroom index = " + chatrooms.indexOf(
        currentChatroom));
   }
   ...
   */
   public Chatroom getChatroom() {
      System.out.println("In Chat.getChatroom");
   ...
   */ 
   ...
   public void leaveChatroom() {
      ...
      System.out.println("In Chat.leaveChatroom");
   }
   ...
   public void postComment(String message) {
      System.out.println("In Chat.postComment");
   ...
   public void askQuestion(String question) {
      //System.out.println("In Chat.askQuestion");
   ...
   public void withdrawQuestion() {
      System.out.println("In Chat.withdrawQuestion");
      question = null;
      System.out.println("Question is now " + question);
   }
   ...
   public void setChatPrivilege(boolean value) {
      canChat = value;
      System.out.println("In Chat.setChatPrivilege");
   }
   ...
   public void changeState()
   {
      setChanged();
      notifyObservers();
      System.out.println("model is changing states!!");
