...
public class CanvasPanel extends JPanel
{
   ...
   */
      ...
      addMouseListener(new
         MouseAdapter()
         {
            public void mousePressed(MouseEvent event)
            {
               ...
               else if (tool instanceof ColorNode) // change color
               {
                   if (n != null)
                   {
                       changeColorSelected();
               ...
               else if (tool instanceof PointNode) // delete
               {
                   if (e != null || n != null)
                   {
                       removeSelected();
   ...
   /**
    *  Changes color of selected node.
    */
   public void changeColorSelected()
   {
       Color color = null;
       ColorSwatch colors = new ColorSwatch();
       ...
       if (selected instanceof RectangleNode)
       {
            RectangleNode node = (RectangleNode) selected;
            node.setColor(color);
       }
       else if (selected instanceof CircleNode)
       {
           CircleNode node = (CircleNode) selected;
           node.setColor(color);
       }
   ...
   */
   ...
   /**
      Draws a single "remover", a filled "x"
      @param g2 the graphics context
      @param x the x coordinate of the center of the grabber
      @param y the y coordinate of the center of the grabber
   */
   public static void drawRemover(Graphics2D g2, double x, double y)
   {
       final int SIZE = 5;
       Color oldColor = g2.getColor();
   ...
   /**
      ...
      @param y the y coordinate of the center of the grabber
   */
   public static void drawColorOne(Graphics2D g2, double x, double y)
   {
       final int SIZE = 5;
       Color oldColor = g2.getColor();
   ...
   /**
      ...
      @param y the y coordinate of the center of the grabber
   */
   public static void drawColorTwo(Graphics2D g2, double x, double y)
   {
       final int SIZE = 5;
       Color oldColor = g2.getColor();
       g2.setColor(Color.RED);
